...
or
plastics <- read.table("data_plastics.csv", sep = ",", header = TRUE)
...
<span style = 'color:#202c3d'><b>2019</b></span> and <span style = 'color:#ac2023'><b>2020</b></span>. <span style = 'color:#ffd966'><b>Increase</b></span> in pollution was more prevalent than <span style = 'color:#b3c6ff'><b>decline</b></span>.<br>",
       caption = "\nSource: Break Free From Plastic | Visualization: Wahyu")+
  theme(plot.background = element_rect(fill = "#8D8DAA", colour = "#8D8DAA"),
        panel.background = element_rect(fill = "#8D8DAA"),
...
# Save the plot
ggsave(p, dpi = 600, filename = "Plasticpollution1.jpeg")
